...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::lyrics::create_lyric,
            commands::lyrics::get_lyric,
            commands::lyrics::list_lyrics,
            commands::lyrics::update_lyric,
            commands::lyrics::delete_lyric,
            commands::lyrics::search_lyrics,
            commands::releases::create_checklist,
            commands::releases::get_checklist,
            commands::releases::get_checklist_for_project,
            commands::releases::list_checklists,
            commands::releases::toggle_checklist_item,
            commands::releases::add_checklist_item,
            commands::releases::remove_checklist_item,
            commands::releases::delete_checklist,
